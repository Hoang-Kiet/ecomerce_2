    ...
    <div class="card">
        ...
        <div class="card-body">
            <?php if ($this->session->flashdata('success')) { ?>
                <div class="alert aler-success"><?php echo $this->session->flashdata('success') ?></div>
            ...
            <form action="<?php echo base_url('category/update/' . $categories['id']) ?>" method="POST" enctype="multipart/form-data">
                ...
                <!-- <div class="form-group">
                    ...
                    <input type="text" name="slug" value="<?php echo $categories['slug'] ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo base_url('uploads/category/' . $categories['image']); ?>" alt="Image" width="150px" height="100px">
